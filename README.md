...
| 标签页 | 功能 |
|--------|------|
| 📝 批阅设置 | 开启/关闭自动批阅，设置星级、评语及“补充批阅评语”评语库 |
...
| `review.supplement_comment` | 已批阅报告补充评语模式；开启后处理尚无教师评语的日报、周报、月报、总结，以及已打分但尚无教师评语的实习成绩考核 |
...
在「批阅设置」中开启“补充批阅评语”，并在评语文本框中按**每行一条**填写候选评语。每次自动任务会查询所有已批阅但尚未填写教师评语的日报、周报、月报和总结报告，以及所有已打分但尚未填写教师评语的实习成绩考核，并为每条记录随机选取一条补充；已有教师评语的记录不会被改写。
