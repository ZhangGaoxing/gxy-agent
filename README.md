...
| `review.supplement_comment` | 已批阅报告补充评语模式；开启后仅处理尚无教师评语的日报、周报、月报、总结 |
...
在「批阅设置」中开启“补充批阅评语”，并在评语文本框中按**每行一条**填写候选评语。每次自动任务会查询所有已批阅但尚未填写教师评语的日报、周报、月报和总结报告，并为每份报告随机选取一条补充；已有教师评语的报告不会被改写。
